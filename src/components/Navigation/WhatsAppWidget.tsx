...
// change at all.
// Real WhatsApp glyph (Simple Icons "whatsapp" path) rather than the 💬 emoji —
// recognisable brand mark, matches what every reference WhatsApp-button plugin uses.
    ...
    <div style={{ position: 'fixed', bottom: 24, right: 24, zIndex: 9998, fontFamily: 'inherit' }}>
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: color, boxShadow: '0 6px 16px rgba(0,0,0,0.24)',
